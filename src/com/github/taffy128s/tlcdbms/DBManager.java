...
public class DBManager implements DiskWritable {
    ...
    public void select(SQLParseResult parameter) {
        ...
        ArrayList<Condition> conditions = parameter.getConditions();
        for (Condition condition : conditions) {
        	...
        	if (!mTables.get(condition.getLeftTableName()).getAttributeNames().contains(condition.getLeftValue())) {
        		System.out.println("Attribute '" + condition.getLeftValue());
        		return;
        	}
        	if (!mTables.get(condition.getRightTableName()).getAttributeNames().contains(condition.getRightValue())) {
        		System.out.println();
        		return;
        	}
        }
